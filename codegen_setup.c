...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Jackie Chan Stuntmaster",
    .project_root_env = "JACKIE_CHAN_STUNTMASTER_RECOMP_PROJECT_ROOT",
    .build_dir_env = "JACKIE_CHAN_STUNTMASTER_RECOMP_BUILD_DIR",
    .force_setup_env = "JACKIE_CHAN_STUNTMASTER_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_006.84_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Jackie_Chan_Stuntmaster_Recompiled",
    .prepare_note =
