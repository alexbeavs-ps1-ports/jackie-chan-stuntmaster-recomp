# Jackie Chan Stuntmaster feasibility binding

## Identity

- Title and region: Jackie Chan Stuntmaster, USA.
- Serial: SLUS-00684.
- Source executable path: `disc/SLUS_006.84`.
- Load address: `0x8002601C`.
- Entry point: `0x8002601C`.
- Source disc binding: `disc/Jackie Chan Stuntmaster (USA).cue`.
...
The clean source commit is `ea03227efd93d010a1457e3716e4b22d94260b58`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 2411 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `ea03227efd93d010a1457e3716e4b22d94260b58`.
- Portfolio `jackie-chan-stuntmaster/BUILDINFO.json`.
- Portfolio `jackie-chan-stuntmaster/RECEIPT.md`.
